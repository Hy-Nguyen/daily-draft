  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <div id="date" className="flex items-center text-2xl">
          {date}
        </div>
        ...
        <div id="info" className="flex flex-col gap-3 text-[#5A5C6F] lg:flex-row lg:items-center lg:gap-6">
          <Tooltip
            classNames={{
              ...
              content: 'bg-[#1A1B23] border border-white/10 w-1/2 px-5 py-3',
            }}
            color="default"
            content={
              <div className="text-white">
                <h1 className="text-small mb-3 font-bold">How to Play</h1>
                <p className="text-tiny">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex at minus maiores a molestias dolore illo.
                </p>
              </div>
            }
          >
            <p className="text-sm underline">How to Play</p>
          </Tooltip>
          <Tooltip
            classNames={{
              base: 'w-full flex justify-center',
            ...
            content={
              <div className="text-white">
                <h1 className="text-small mb-3 font-bold">Details</h1>
                <p className="text-tiny">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex at minus maiores a molestias dolore illo.
                </p>
              </div>
          ...
          <Tooltip
            ...
            content={
              <div className="text-white">
                <h1 className="text-small mb-3 font-bold">Scoring</h1>
                <p className="text-tiny">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex at minus maiores a molestias dolore illo.
                </p>
              </div>
          ...
          >
            <p className="text-sm underline">Scoring</p>
          </Tooltip>
          <YellowBadge />
        </div>
      </div>

export function TournamentImage() {
  return (
    <div id="image" className="flex h-3/5 w-3/5 items-center justify-center rounded-full bg-[#131619] py-2">
...
export function TournamentImageRight() {
  return (
    <div id="image" className="z-10 -ml-6 flex h-3/5 w-3/5 items-center justify-center rounded-full bg-[#131619] py-2">
